...
public class AuthEventHandler extends ServerEventHandler
{
    ...
    public void playerMoveEvent(PlayerMoveEvent event)
    {
        ...
        if (!ModuleAuth.isAuthenticated(event.entityPlayer))
        {
            ...
            ChatOutputHandler.chatError(event.entityPlayer, "Veuillez vous connecter avec /login motdepasse");
        }
    }
    ...
    public void serverChatEvent(ServerChatEvent event)
    {
        ...
        {
            event.setCanceled(true);
            ChatOutputHandler.chatError(event.player, "Veuillez vous connecter avec /login motdepasse");
        }
    }
    ...
    public void commandEvent(CommandEvent event)
    {
        ...
        {
            event.setCanceled(true);
            ChatOutputHandler.chatError(player, "Veuillez vous connecter avec /login motdepasse");
        }
    }
    ...
    public void playerLoggedInEvent(PlayerLoggedInEvent event)
    {
        ...
        {
            ChatOutputHandler.chatError(event.player, "Veuillez vous inscrire avec /register motdepasse");
        }
        else
        {
            ChatOutputHandler.chatError(event.player, "Veuillez vous connecter avec /login motdepasse");
